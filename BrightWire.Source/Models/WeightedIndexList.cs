...
namespace BrightWire.Models
{
    ...
    /// </summary>
    [ProtoContract]
    public class WeightedIndexList : IReadFromBinaryReader
    {
        /// <summary>
        /// A weighted index
        /// </summary>
        ...
        {
            var ret = new WeightedIndexList();
            var readFrom = (IReadFromBinaryReader)ret;
            readFrom.ReadFrom(reader);
            return ret;
        }

        void IReadFromBinaryReader.ReadFrom(BinaryReader reader)
        {
            var len = reader.ReadInt32();
            IndexList = new WeightedIndex[len];
