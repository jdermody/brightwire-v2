...
namespace BrightWire
{
    ...
    public static class BrightWireProvider
    {
        ...
        /// <summary>
        /// Creates a new model class that has been serialised
        /// </summary>
        /// <param name="reader">Read to read from</param>
        /// <typeparam name="T">Model type</typeparam>
        /// <returns>Model instance</returns>
        public static T Create<T>(BinaryReader reader) where T : IReadFromBinaryReader => ModelSerialisation.Create<T>(reader);
    }
}
